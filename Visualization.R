...
ggplot(broadband, aes(y = Town)) +
  labs(x = "Speeds (Mbits/s)", y = "Town", title = "Broadband Speed of Oxfordshire") +
  ...
  scale_fill_manual(values = c(Average = "blue", Minimum = "red")) +
  guides(fill = guide_legend("Download Speeds"))

#Yorkshire Broadband speed visualization

ggplot(broadband, aes(y = Town)) +
  labs(x = "Speeds (Mbits/s)", y = "Town", title = "Broadband Speed of Yorkshire") +
